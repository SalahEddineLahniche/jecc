<?php 
	...
	$sql = 'CREATE TABLE IF NOT EXISTS `posts` (`id` int(11) NOT NULL, `ptext` text NOT NULL, `plink` text NOT NULL, `departement_id` int(11) NOT NULL);';
	$retval = mysql_query( $sql, $conn );
	if(! $retval ) {
	...
	$sql = 'INSERT INTO `departements` (`id`, `dname`) VALUES (0, \'general\'), (1, \'projets\'), (2, \'confederation\'), (3, \'prospection\');';
	$retval = mysql_query( $sql, $conn );
	if(! $retval ) {
